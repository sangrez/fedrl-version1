...
class JointAgent:
    ...
    def get_weights(self):
        return (self.dqn.state_dict(), self.dqn_target.state_dict(), self.td3.actor.state_dict(), self.td3.critic.state_dict())

    def set_weights(self, weights):
        self.dqn.load_state_dict(weights[0])
        self.dqn_target.load_state_dict(weights[1])
        self.td3.actor.load_state_dict(weights[2])
        self.td3.critic.load_state_dict(weights[3])
